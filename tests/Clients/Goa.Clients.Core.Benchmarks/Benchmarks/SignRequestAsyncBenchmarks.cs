...
using Goa.Clients.Core.Benchmarks.Infrastructure;
...
[CategoriesColumn]
public class SignRequestAsyncBenchmarks
{
    ...
    [Benchmark, BenchmarkCategory("Medium")]
    ...
    [Benchmark, BenchmarkCategory("XLarge")]
    ...
    [Benchmark(Baseline = true), BenchmarkCategory("Medium")]
    ...
    [Benchmark(Baseline = true), BenchmarkCategory("XLarge")]
