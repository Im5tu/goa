...
public readonly struct AttributeValue
{
    ...
    public T? ToValue<T>()
    {
        ...
        return typeof(T) switch
        {
            ...
            var t when t == typeof(double) => double.TryParse(N, NumberStyles.Any, CultureInfo.InvariantCulture, out var d) ? (T?)(object?)d : default,
            var t when t == typeof(decimal) => decimal.TryParse(N, NumberStyles.Any, CultureInfo.InvariantCulture, out var m) ? (T?)(object?)m : default,
